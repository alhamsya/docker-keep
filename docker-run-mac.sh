...
docker run --detach --name=metabase-test --net docker-network --ip 182.28.0.6 --publish 3000:3000 --volume metabase-volume:/metabase-data --platform linux/amd64 metabase/metabase
