...
docker run --detach --name=jaegert-test --net docker-network --ip 182.28.0.9 --publish 6831:6831/udp --publish 16686:16686 -env="JAEGER_AGENT_HOST=jaeger-test" jaegertracing/all-in-one:latest
